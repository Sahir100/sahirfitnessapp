...
public class Rest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1 = findViewById(R.id.text_rest);
        button = findViewById(R.id.button_skip);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Rest.this, Walk.class));
    ...
    class Timer extends CountDownTimer {
        ...
        public void onFinish() {
            MediaPlayer player = MediaPlayer.create(Rest.this, Settings.System.DEFAULT_NOTIFICATION_URI);
            player.start();
            Toast.makeText(Rest.this, "Time for Next Exercise", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(Rest.this, Walk.class));
        }
    }
}
